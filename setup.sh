...
# Fetch the API modules from the pinned repository revision.
...
fetch_api_code() {
  ...
  for f in main.py workflows.py motion_reference.py face_targeting.py image_output.py safety.py logo_safety.py watermark.py; do
